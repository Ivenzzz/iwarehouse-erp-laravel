...
export const getStatusColor = (status) => {
  const colors = {
    ...
    reserved_for_transfer: "bg-yellow-100 text-yellow-800",
    for_branch_transfer: "bg-blue-100 text-blue-800",
    ...
    for_return_to_supplier: "bg-purple-100 text-purple-800",
    on_hold: "bg-yellow-100 text-yellow-800",
    damaged: "bg-red-100 text-red-800",
    stolen_lost: "bg-red-100 text-red-800",
    scrap: "bg-gray-100 text-gray-800",
    in_transit: "bg-blue-100 text-blue-800 dark:bg-blue-500/15 dark:text-blue-400",
    bundled: "bg-gray-100 text-gray-800",
  };
...
export const getStockAgeColor = (encodedDate) => {
  if (!encodedDate) return "text-gray-500";

  const encodedTs = getZonedTimestamp(encodedDate);
  const nowTs = getZonedTimestamp(new Date());
  if (encodedTs === null || nowTs === null) return "text-gray-500";
  ...
  if (diffDays < 180) return "text-orange-600";
  return "text-red-600";
};
