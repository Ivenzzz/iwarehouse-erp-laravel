...
function DialogHeader({ className, ...props }) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1 border-b mb-2 px-2 py-4", className)}
      {...props}
    />
  );
}
