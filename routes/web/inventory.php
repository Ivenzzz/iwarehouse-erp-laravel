...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/inventory/batch/update', [InventoryController::class, 'batchUpdate'])->middleware('permission:inventory.update')->name('inventory.batch.update');
    Route::delete('/inventory/batch', [InventoryController::class, 'batchDelete'])->middleware('permission:inventory.delete')->name('inventory.batch.delete');
